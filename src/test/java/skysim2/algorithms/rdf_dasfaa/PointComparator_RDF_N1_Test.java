 ...
 * @author Christoph
 */
public class PointComparator_RDF_N1_Test {

    public PointComparator_RDF_N1_Test() {
    }
    ...
    public void testCompare() {
        ...
        PointComparator_RDF comparator = new PointComparator_RDF_N1(0.2f);
        {     
            float[] a = {0.7f, 0.7f, 0.9f};
            float[] b = {1f, 1f, 0.8f};
        ...
        {
            float[] b = {0.8f, 0.8f, 0.8f};
            float[] a = {0.8f, 0.8f, 0.8f};
