...
import ifis.skysim2.algorithms.rdf_dasfaa.SkylineAlgorithm_RDF_BNL;
...
import ifis.skysim2.algorithms.rdf_dasfaa.SkylineAlgorithm_RDF_sorted;
...
public class Experiment_Dasfaa2012_n1_sort_delta {
...
//	config.setDataGenerator(new DataGeneratorUnitAnnulusUnif(0.3));
        ...
        config.setSkylineAlgorithm(new SkylineAlgorithm_RDF_sorted(comparator, new SkylineAlgorithm_RDF_BNL(comparator)));
