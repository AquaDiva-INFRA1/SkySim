...
/**
 * This skyline comparator allows for malleable and non-malleable attributes,
 * with no restrictions or improvements. It assumes that the first half of the
 * tuple is non-malleable, and the second one is malleable.
 *
 * @author Christoph
 */
